...
.. |github ci| image:: https://img.shields.io/github/checks-status/yourtulloh/ktlkuda/main?style=flat-square
   :target: https://github.com/yourtulloh/ktlkuda/actions?query=branch%3Amain
.. |codecov| image:: https://img.shields.io/codecov/c/gh/yourtulloh/ktlkuda/main?style=flat-square
   :target: https://app.codecov.io/gh/yourtulloh/ktlkuda
...
.. |codacy| image:: https://img.shields.io/codacy/grade/ef2975376e834af1910632cb76d05832?style=flat-square
   :target: https://app.codacy.com/gh/yourtulloh/ktlkuda/dashboard
...
.. code:: console
    ...
    pip install git+https://github.com/yourtulloh/ktlkuda.git@main#egg=qbittorrent-api
...
.. code:: python
    ...
    qbt_client = ktlkuda.Client(**conn_info)
    ...
    except ktlkuda.LoginFailed as e:
        print(e)
...
.. code:: python
    ...
    import ktlkuda
    qbt_client = ktlkuda.Client(host='localhost:8080', username='admin', password='adminadmin')
