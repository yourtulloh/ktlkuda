...
from ktlkuda import APIConnectionError
from ktlkuda import Client
from ktlkuda._version_support import (
...
def setup_environ():
    ...
    environ.setdefault("ktlkuda_HOST", "localhost:8080")
    environ.setdefault("ktlkuda_USERNAME", "admin")
    environ.setdefault("ktlkuda_PASSWORD", "adminadmin")
    try:
